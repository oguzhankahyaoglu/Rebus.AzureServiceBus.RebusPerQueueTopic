...
namespace Rebus.AzureServiceBus.RebusPerQueueTopic.ConfigMasstransit
{
    ...
    /// </summary>
    public class AzureServiceBusTopicOneWayToMasstransitTransport : ITransport, IInitializable, IDisposable, ISubscriptionStorage
    {
        /// <summary>
        ...
        /// </summary>
        public AzureServiceBusTopicOneWayToMasstransitTransport(string connectionString,
            string topicName,
        ...
        private ServiceBusMessage GetMessage(OutgoingMessage outgoingMessage)
        {
            ...
            {
                var (parsedMessageId, parsedType) = MasstransitHelpers.SetMessageIdFromMasstransitMessage(message.Body.ToArray(),
                    _log);
