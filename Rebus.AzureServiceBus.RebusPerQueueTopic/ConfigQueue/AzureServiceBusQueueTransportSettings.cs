...
namespace Rebus.AzureServiceBus.RebusPerQueueTopic.ConfigQueue
{
    ...
    /// </summary>
    public class AzureServiceBusQueueTransportSettings
    {
        ...
        internal TimeSpan ReceiveOperationTimeout { get; set; } = TimeSpan.FromMinutes(1);
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings EnablePartitioning()
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetMessagePayloadSizeLimit(int maximumMessagePayloadBytes)
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetDuplicateDetectionHistoryTimeWindow(TimeSpan duplicateDetectionHistoryTimeWindow)
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetAutoDeleteOnIdle(TimeSpan autoDeleteOnIdleDuration)
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetDefaultMessageTimeToLive(TimeSpan messageTimeToLive)
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetMessagePeekLockDuration(TimeSpan messagePeekLockDuration)
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings EnablePrefetching(int numberOfMessagesToPrefetch)
        {
        ...
        // </summary>
        // public AzureServiceBusQueueTransportSettings AutomaticallyRenewPeekLock()
        // {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings UseLegacyNaming()
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings DoNotCreateQueues()
        {
        ...
        /// input queue (which is probably the preferred approach with this option)
        /// </summary>
        public AzureServiceBusQueueTransportSettings DoNotCheckQueueConfiguration()
        {
        ...
        /// </summary>
        public AzureServiceBusQueueTransportSettings SetReceiveOperationTimeout(TimeSpan receiveOperationTimeout)
        {
