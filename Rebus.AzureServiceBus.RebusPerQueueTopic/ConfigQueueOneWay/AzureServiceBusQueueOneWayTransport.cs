...
namespace Rebus.AzureServiceBus.RebusPerQueueTopic.ConfigQueueOneWay
{
    /// <summary>
    /// Implementation of <see cref="ITransport"/> that uses Azure Service Bus queues to send/receive messages.
    /// </summary>
    public class AzureServiceBusQueueOneWayTransport : ITransport, IInitializable, IDisposable, ISubscriptionStorage
    {
        /// <summary>
        ...
        /// </summary>
        public AzureServiceBusQueueOneWayTransport(string connectionString,
